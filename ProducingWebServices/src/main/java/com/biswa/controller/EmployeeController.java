...
public class EmployeeController {
	...
	public String save(@RequestBody Employee e) {
		/*
		 * Employee e = new Employee(); e.setId(1111);
		 * e.setName("Saumyaranjan Mohapatra"); e.setJob("Project Engineer");
		 * e.setSalary(855555);
		 */
	...
	/*
	 * @RequestMapping("/callProc") public String getEmpProc() {
	 * employeeDAO.employeeDetails(1112); return "getEmpProc"; }
	 */
}
